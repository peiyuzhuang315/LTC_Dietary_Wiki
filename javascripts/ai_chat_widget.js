...
(function () {
  ...
  // ── 長照專家角色 ──────────────────────────────────────────────
  const EXPERTS = [
    { emoji:"📋", color:"#1565c0", digitalTitle:"長照需求評估師", realRole:"照服專員",
    ...
    { emoji:"🗂️", color:"#6a1b9a", digitalTitle:"照護計畫規劃師", realRole:"個管師",
      persona:"你以照護方案架構師（個管師）身份回答，專長生成個人化照護計畫與服務媒合。",
      skills:["排程優化","資源分配邏輯"],
      keywords:["照護計畫","個管","服務媒合","方案","排程","個案管理","照護團隊","多職種","整合照顧"] },
    { emoji:"🩺", color:"#c62828", digitalTitle:"居家護理照護師", realRole:"居家護理師",
    ...
    { emoji:"🏃", color:"#2e7d32", digitalTitle:"復能復健指導師", realRole:"物理/職能治療師",
    ...
    { emoji:"🙌", color:"#f57c00", digitalTitle:"日常生活照顧師", realRole:"照服員",
    ...
    { emoji:"🏛️", color:"#0277bd", digitalTitle:"社會福利諮詢師", realRole:"社工",
    ...
    { emoji:"💙", color:"#7b1fa2", digitalTitle:"心理健康諮詢師", realRole:"心理師",
    ...
    { emoji:"💊", color:"#d84315", digitalTitle:"藥物安全諮詢師", realRole:"藥師",
    ...
    { emoji:"🏠", color:"#558b2f", digitalTitle:"居家環境改善師", realRole:"輔具評估員",
...
溝通原則：
- 若問題含情緒訊號（如「怎麼辦」「好累」「撐不住」「一直這樣」），先用 1-2 句話真誠承認困境，再切入建議
- 絕對禁止空洞開場（「您問得很好！」「感謝您的提問」）
- 語氣專業直接，不繞彎，回答200-400字，條列清晰
- 回答結尾輸出：「📖 關聯詞條：詞條A、詞條B」`;
