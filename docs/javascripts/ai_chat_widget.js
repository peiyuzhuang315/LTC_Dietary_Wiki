...
(function () {
  ...
  const EXPERTS = [
    ...
    { emoji:"🗂️", color:"#6a1b9a", digitalTitle:"照護方案架構師", realRole:"個管師",
      ...
      skills:["排程優化","資源分配邏輯"],
      keywords:["照護計畫","個管","服務媒合","方案","排程","個案管理"] },
    ...
    { emoji:"🥗", color:"#00897b", digitalTitle:"精準營養規劃師", realRole:"營養師",
      ...
      keywords:["飲食","吞嚥","營養","食物","管灌","膳食","配方","熱量","蛋白質","吃","進食","不吃飯","限鉀","低鈉"] },
    ...
    { emoji:"🏛️", color:"#0277bd", digitalTitle:"福利資源導航員", realRole:"社工",
      ...
      keywords:["補助","申請","政策","長照2.0","福利","補貼","社工","法規","1966","長照服務","補助資格"] },
...
回答規則：
1. 繁體中文，語氣專業直接，絕不說寒暄語或開場白
2. 回答長度適中（200-400 字），結構清晰，善用分點或段落
3. 回答結尾必須輸出：「📖 關聯詞條：詞條A、詞條B、詞條C」`;
